package com.wokercompras.domain.service.rabbitmq;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.wokercompras.domain.model.Pedido;
import com.wokercompras.domain.service.PedidoService;
...
public class PedidoConsumerService {
    ...
    public void consumer(@Payload Message payload){
        ...
        log.info("Payload enviado para o validador" + pedido);
    }
}
